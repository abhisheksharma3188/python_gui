...
class MainFrame:
    def __init__(self, root):
        ...
        self.label = tk.Label(self.frame, text="Main frame", bg='red', fg="white", font=("Helvetica", 16))  # this creates label in frame
        self.label.pack(pady=20)  # this displays label in frame
        self.button1 = tk.Button(self.frame, text="Second", command=self.open_second_frame)  # this creates button in frame
